    ...
    <header class="header">
      <div class="container">
        <div class="header__inner">
          ...
          <div class="logo-box">
            <?php if ($header_logo) : ?>
              <a href="<?php echo home_url(); ?>" class="logo-box__link" aria-label="Rankexperts logo">
                <img loading="lazy" class="logo-box__img" src="<?php echo esc_url($header_logo); ?>" alt="<?php echo esc_attr($header_logo_alt) ?> " width="185" height="85">
              </a>
            <?php endif; ?>
          </div>
          <!-- logo end -->
          ...
          <div class="header__navigation">
            ...
            <div class="mob-nav" id="mob-nav" hidden aria-label="mobile menu">
