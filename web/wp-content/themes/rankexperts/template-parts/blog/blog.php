          ...
          <?php if ($count === 1) : ?>
            <article class="blog-article">
              ...
              <?php else : ?>
                <picture class="blog-article__img">
                  <source media="(min-width:767px)" srcset="<?php echo esc_attr($srcset); ?>" />
                  <img src="<?php echo get_template_directory_uri() . '/images-custom/no-image-showcase.webp'; ?>" alt="<?php the_title_attribute(); ?>" />
                </picture>
              <?php endif; ?>
              ...
              <article class="blog-article__left">
                <div class="blog-article__items">
                  <div class="blog-article__item">
                    <?php
                    if (has_post_thumbnail()) : ?>
                      <img class="blog-article__left-img" src="<?php the_post_thumbnail_url('medium_large'); ?>" alt="<?php the_title_attribute(); ?>" />
                    <?php else : ?>
                      <img class="blog-article__left-img" src="<?php echo get_template_directory_uri() . '/images-custom/no-image-showcase.webp'; ?>" alt="<?php the_title_attribute(); ?>" />
                    <?php endif; ?>
                  </div>
                  <div class="blog-article__item">
                    <div class="blog-article__box">
  ...
  <div class="pagination">
    <div class="container">
      <div class="pagination__items">
        ...
        // Add aria-label only for brn Next and Previous
