<div class="showcase-item" <?php post_class(); ?> id="post-<?php the_ID(); ?>" data-post-id="<?php the_ID(); ?>">
  ...
  ?>
    <img class="showcase-item__img" src="<?php echo esc_url($image_url); ?>" alt="" />
  <?php } ?>
  <div class="showcase-item__title"><?php the_title(); ?></div>
  <div class="showcase-itembox">
    <div class="showcase-item__date"><?php echo get_the_date('j F Y'); ?></div>
