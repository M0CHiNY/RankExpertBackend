...
function rankexsperts_register_post_type()
{
  ...
  $labels = array(
    'name' => esc_html_x('Services', 'Post type general name', 'rankexsperts'),
    ...
    'name_admin_bar' => esc_html_x('Services', 'Add New on Toolbar', 'rankexsperts'),
    ...
    'featured_image' => esc_html_x('Services Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'rankexsperts'),
  ...
  $args = array(
    ...
    'show_in_menu' => true,
    'has_archive' => true,
    'rewrite' => array('slug' => 'online-marketing'),
  ...
  register_post_type('onlinemarketing', $args);
