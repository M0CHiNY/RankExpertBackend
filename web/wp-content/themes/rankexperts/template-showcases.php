...
<section class="showcases">
    <div class="container">
        <h1 class="showcases__title title"><?php ?></h1>
        <p class="showcases__descr">Delve into the intricacies of our meticulously crafted case studies and
            discover how we've propelled businesses like yours to SEO success. Each case study unveils the
            challenges we encountered, the strategies we meticulously implemented, and the remarkable
            results we triumphantly achieved</p>
        <div class="showcases__wrap">
            <div class="showcase-item"><img class="showcase-item__img" src="images/design/showcase-item.8aff61.jpg"
                    alt="" />
                <div class="showcase-item__title">SEO for Tax Lawyers Company</div>
                <div class="showcase-itembox">
                    <div class="showcase-item__date">12 November 2023</div><a class="showcase-item-btn" href="#">View
                        Case Study<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                            fill="none">
                            <path
    ...
    <div class="pagination">
        <div class="container">
            <ul class="pagination__items">
                <div class="pagination__item-prev"><a href="#" class="pagination__item-prev-link"><svg width="50"
                ...
                <div class="pagination__item-next"><a href="#" class="pagination__item-prev-next"><svg width="50"
                            height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
